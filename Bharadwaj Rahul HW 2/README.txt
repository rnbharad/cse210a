You can utilize "make" to create a while file.

Then, we utilize "bash test.sh" to run the test cases.

Ignore the while error, it does not affect any other portion of the project. I was not able
...
My own 5 created test cases are in the hard.bats file. I implemented ARRAYs as my 
additional feature.
