...
@test "custom-1" {
  check 'array := [1, 2, 3, 4]' '{array → [1, 2, 3, 4]}'
}

@test "custom-2" {
  check 'array := [10, 20, 30, 40]' '{array → [10, 20, 30, 40]}'
}

@test "custom-3" {
  check 'x := 2; array := [10, 20, 30, 40]' '{array → [10, 20, 30, 40], x → 2}'
}

@test "custom-4" {
  check 'skip; x := 2; array := [10, 20, 30, 40]' '{array → [10, 20, 30, 40], x → 2}'
}

@test "custom-5" {
  check 'skip; if false then array := [10, 20, 30, 40] else x := 3' '{x → 3}'
}
